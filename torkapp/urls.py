...
urlpatterns = patterns('',
    ...
    url(r'^api/rest/v1/sessions/$', TorqueSessionsListView.as_view(), name='all-sessions'),
    url(r'^api/rest/v1/sessions/(?P<session>[0-9]+)/$', TorqueDataSessionView.as_view(), name='session-list'),
