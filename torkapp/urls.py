...
from views import UserViewSet, TorqueDataViewSet, TorqueDataSessionView, TorqueSessionsListView, UploadForm, KnownCodesView
...
urlpatterns = patterns('',
    ...
    url(r'^api/v1/fields/$', KnownCodesView.as_view(), name='static_fields'),
